...
let
    ...
    envConfig = "REGISTRATION_AGENT_PROVISIONING_URL=http://localhost:80/api/devices/provision\
...
\nREGISTRATION_AGENT_DEVICE_CONFIG_PATH=${cfg.config-path}";
